...
import 'package:flutter_cupertino_date_picker/src/date_picker_constants.dart';
import 'package:flutter_cupertino_date_picker/src/i18n/date_picker_i18n.dart';
import 'package:flutter_cupertino_date_picker/src/widget/date_picker_title_widget.dart';
...
class _dateTimePickerWidget extends State<DateTimePickerWidget> {
  ...
  _dateTimePickerWidget(DateTime minTime, DateTime maxTime, DateTime initTime) {
    // check minTime value
    if (minTime == null) {
    ...
    this._currYear = min(max(minTime.year, _currYear), maxTime.year);
  ...
  List<Widget> _renderDayDatePickerWidget(String dayFormat) {
    List<Widget> pickers = List<Widget>();
    List<String> formatArr =
    DateTimeFormatter.splitDateFormat(dayFormat);
  ...
  Widget _renderDatePickerWidget() {
    ...
    pickers.addAll(_renderDayDatePickerWidget(dayFormat));
